...
const DEFAULT_SITE_CONTENT: Record<string, unknown> = {
  ...
  fitout: {
    eyebrow_en: 'Fit-Out',
    eyebrow_ar: '',
    title_en: 'Fit-Out Services',
    title_ar: '',
    body_en:
      'We deliver end-to-end interior fit-out solutions — from concept and material selection to final installation — for residential, commercial, and hospitality spaces.',
    body_ar: '',
    image_url: '',
    stat_primary_value_en: 'Complete',
    stat_primary_value_ar: '',
    stat_primary_label_en: 'Turnkey fit-out delivery',
    stat_primary_label_ar: '',
    stat_1_value_en: '100+',
    stat_1_value_ar: '',
    stat_1_label_en: 'Fit-out projects',
    stat_1_label_ar: '',
    stat_2_value_en: '30+',
    stat_2_value_ar: '',
    stat_2_label_en: 'Days avg. delivery',
    stat_2_label_ar: '',
    stat_3_value_en: '100%',
    stat_3_value_ar: '',
    stat_3_label_en: 'Client satisfaction',
    stat_3_label_ar: '',
  },
  blog: {
    eyebrow_en: 'Blog',
    eyebrow_ar: '',
    title_en: 'Ideas & Insights',
    title_ar: '',
    body_en:
      'Explore our latest thoughts on interior design, material trends, and the art of creating spaces that feel like home.',
    body_ar: '',
    image_url: '',
    stat_primary_value_en: '',
    stat_primary_value_ar: '',
    stat_primary_label_en: '',
    stat_primary_label_ar: '',
    stat_1_value_en: '',
    stat_1_value_ar: '',
    stat_1_label_en: '',
  ...
  careers: {
    ...
    title_ar: '',
    body_en:
      'We are always looking for talented individuals who are passionate about design and craftsmanship. Send us your portfolio and let\'s build something great together.',
    body_ar: '',
    image_url: '',
    stat_primary_value_en: '',
    stat_primary_value_ar: '',
